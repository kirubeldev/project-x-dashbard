...
import { ForsellGraph, SoldGraph } from './forsellGraph'; // Import the ActivityGraph component
    ...
    <div className="relative">
      <div className="p-4 rounded border border-stone-300">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-lg font-medium">Properties sold in Addis Ababa</h3>
        ...
        {showGraph ? (
          <SoldGraph data={currentData} /> // Use ActivityGraph component
        ) : (
          <>
...
const TableRow = ({ name, quantity, price, sku, category, region, onClick, order }) => {
  return (
    ...
    >
      <div className="bg-white w-1/3 h-full p-6 rounded-l-lg shadow-lg relative overflow-y-auto">
        ...
        <div className="flex items-center mb-2">
          ...
          <p><strong>SKU:</strong> {property.sku}</p>
        </div>
        <div className="flex items-center mb-2">
